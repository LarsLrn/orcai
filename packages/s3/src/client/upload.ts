...
import { ClientUploadErrorClass } from "./error";
import type { SignedUrlsSuccessResponse } from "./internal";
import type {
	DirectUploadResult,
	FileUploadInfo,
	UploadStatus,
...
export async function uploadFiles<TRoute extends string>(params: {
	route: TRoute;
