			...
			<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2 2xl:grid-cols-3">
				{assetIds.map((id) => (
					<Card key={id} className="h-40">
						<CardContent className="h-full animate-pulse">
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Configure the AI provider, embedding model, and reference behavior for
					this block.
				</CardDescription>
			</CardHeader>
			...
			<CardContent className="space-y-6">
				...
				<div className="space-y-3">
					<div className="flex items-center gap-2">
						...
						<div className="font-medium text-sm">Reference Assets</div>
					</div>
