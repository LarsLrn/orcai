...
export const UPLOAD_ROUTES = {
	asset: {
		...
		signedUrlExpiresIn: 60 * 30, // 30min
		multipart: {
			mode: "auto",
			thresholdSize: 10 * 1024 * 1024, // 10MB
			partSize: 10 * 1024 * 1024, // 10MB
			partSignedUrlExpiresIn: 60 * 30, // 30min
		},
		allowedMimePatterns: [
			"image/*",
			"video/*",
	...
	chatAttachment: {
		...
		signedUrlExpiresIn: 60 * 15, // 15min
		multipart: {
			mode: "auto",
			thresholdSize: 10 * 1024 * 1024, // 10MB
			partSize: 10 * 1024 * 1024, // 10MB
			partSignedUrlExpiresIn: 60 * 15, // 15min
		},
		allowedMimePatterns: [
			"image/*",
			"application/pdf",
