...
const buildKnowledgeBaseGuidance = () =>
	[
		...
		"- Page is optional. If source.chunkPageStart and source.chunkPageEnd are both available and equal, set page to source.chunkPageStart.",
		"- If a chunk spans multiple pages, omit the page attribute instead of guessing.",
		"- source.documentTotalPages is the total page count of the document, not the page span of the chunk.",
