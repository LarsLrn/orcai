...
1. Register from the invitation link with its matching email address, which joins
   that organisation. Other invitations remain pending in the organisation picker.
   Email verification is optional for access.
